      ...
      try {
        ...
        if (dishResult.success) {
          ...
          setFormData({
            ...
            category_id: dishData.category_id ? dishData.category_id.toString() : 'null',
            available: dishData.available,
            is_featured: dishData.is_featured,
            preparation_time: dishData.preparation_time || 15,
            calories: dishData.calories || '',
            allergens: dishData.allergens || [],
            ingredients: dishData.ingredients || [],
            sort_order: dishData.sort_order || 0
          });
          setImagePreview(dishData.image || null);
        } else {
          toast.error(dishResult.message || 'Gagal memuat data menu');
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Perbarui informasi untuk menu: {formData.name}
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Informasi utama tentang menu yang akan diubah
                </CardDescription>
              </CardHeader>
